    ...
    public partial class SolutionInitView : SolutionInitViewBase
    {
        public SolutionInitView()
        {
            ...
            this.WhenActivated(dispose =>
            {
                ...
                this.WhenAnyValue(x => x.ViewModel!.AutogeneratedName)
                    .Subscribe(x => TextBoxHelper.SetWatermark(this.PatcherDetailName, string.IsNullOrWhiteSpace(x) ? "Patcher Name" : x))
                    .DisposeWith(dispose);
            });
        }
    }
